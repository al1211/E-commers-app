...
export default function Signup() {
  ...
  return (
    <>
      ...
      <div className="signup-root min-h-screen bg-gradient-to-br from-slate-900 via-violet-950 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
